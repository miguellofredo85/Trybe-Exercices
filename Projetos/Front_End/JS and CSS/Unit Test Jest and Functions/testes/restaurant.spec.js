...
/*
  ...
  Deve ser possível, através desse sistema, cadastrar um menu. Dado que um menu foi cadastrado, o 
  sistema deve disponibilizar um objeto através do qual se consegue:
  ...
  - Uma chave `consumption` que contém um array de strings, 
  com cada string sendo a chave de um pedido. Por exemplo: ['coxinha', 'cerveja']
...
*/
// fazendo com ajuda de GUSTAVO SANTOS TURMA 19 B
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  ...
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    if(objetoRetornado.order('coixinha')) expect(objetoRetornado.consumption).toEqual(['coixinha']);
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    // ```
    if(objetoRetornado.order('sopa') && objetoRetornado.order('cerveja')) expect(objetoRetornado.consumption).toEqual(['coixinha', 'sopa', 'cerveja']);
    // objetoRetornado.order("coxinha");
    ...
    if(objetoRetornado.order('sopa')) expect(objetoRetornado.consumption).toEqual(['coixinha', 'sopa', 'cerveja', 'sopa'])
    // objetoRetornado.order('coxinha');
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
